...
<html class="no-js" lang="zxx">
    <head>
		...
		<link rel="shortcut icon" type="{{asset('')}}image/x-icon" href="assets/img/favicon.ico">
   ...
   <body>
      <!-- <h2>This Data From Controller <?php //echo var_dump($info);?></h2>-->
    <!-- Preloader Start -->
                ...
                <div class="row">
                    ...
                    <div class="col-xl-7 col-lg-7">
                        ...
                        <div class="about-img ">
                            ...
                            <div class="{{asset('')}}about-back-img f-right d-none d-md-block">
                ...
                <div class="row">
                    <div class="col-xl-8 col-lg-8 offset-lg-2 offset-xl-2">
                        ...
                        <!--Section Tittle  -->
                            ...
                            <!--End Section Tittle  -->
                            <form id="contact-form" action="{{route('seveConsultation')}}" method="POST ">
                            <div class="row">
								  <!--{{csrf_field()}}-->
                        ...
                        <div class="tab-pane fade" id="nav-last" role="tabpanel" aria-labelledby="nav-last-tab">
                            <div class="row">
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-6">
                                    <div class="single-practice mb-30">
                                        <div class="practice-img">
                                            <img src="{{asset('ssets/img/legal/legal_1.png')}}" alt="">
                                            <!-- "practice-icon-->
                                            <div class="practice-icon">
                                                <span>Accidental</span>
                                            </div>
