    ...
    <div class="container">
      <form class="form-login" action="{{route('checklogin')}}" method="post">
        ...
        <div class="login-wrap">
          ...
          <p style="color :red; font-size: 14px;font-weight: bold;margin-top:3px;"class="form-login-heading">
          ...
          <a class="btn btn-theme btn-block" href="{{route('registration')}}"type="submit"><i class="fa fa-lock"></i> Create an Account</a>
